  ...
  return (
    ...
    >
      <div className="max-w-md   bg-white mx-auto shadow-lg rounded-lg flex align-center my-48  flex-col  p-10  overflow-hidden">
        <button
          className="place-self-end  text-[#272444]  p-0 "
          onClick={onClose}
        >
          <AiOutlineClose size={20} />
        </button>
        <h1 className="text-2xl font-bold mb-7 text-[#272444] text-center">
          Password Manager
        </h1>
        <form onSubmit={handleSubmit} className="max-w-md">
          <div className="relative">
            <label
              ...
              className="block text-[#272444] font-medium  mb-2"
            >
              Current Password
            </label>
