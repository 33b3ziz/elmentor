...
const ContactSection = () => {
    ...
    return (
        <Form {...form}>
            ...
            >
                <div className=" mx-auto overflow-hidden my-10 w-full md:w-1/3 ">
                    <div className=" px-4 py-2 my-3">
                        <h1 className="text-3xl font-semibold m-5 text-center text-primary">Contact Us</h1>
                        <FormField
                            name="name"
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="relative">
                                    ...
                                    <FormControl>
                                        <Input type="email" id="email" {...field} className="py-6"
