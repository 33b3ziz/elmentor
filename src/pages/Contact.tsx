...
const Contact = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white w-full md:w-1/3  overflow-hidden my-10 text-[#272444] ">

      <form onSubmit={handleSubmit(onSubmit)} >
        <h1 className="text-4xl font-semibold mt-10 mb-5 text-center">Contact Us</h1>
  ...
  return (
    <div className=" mx-auto bg-white  overflow-hidden my-10 text-gray-500 w-full md:w-1/3 ">
      <div className=" px-4 py-2 my-3">
        <form onSubmit={handleSubmit(onSubmit)} >
          <h1 className="text-3xl font-semibold m-5 text-center text-[#272444]">Contact Us</h1>

          <div className="mb-4">
            <Label htmlFor="name" className="text-[#272444]">Name</Label>
            <div className="relative">
              <Input
                type="text"
                id="name"
          ...
          <div className="mb-4">
            <Label htmlFor="phone" className="text-[#272444]">Phone number</Label>
            <div className="relative">
              <Input
                type="phone"
                id="phone"
          ...
          <div className="mb-4">
            <Label htmlFor="email" className="text-[#272444]">Email</Label>
            <div className="relative">
              <Input
                type="email"
                id="email"
          ...
          <div className="mb-4">
            <Label htmlFor="message" className="text-[#272444]">Your Message</Label>
            <div className="relative">
              <textarea
                id="message"
                {...register("message", { required: "Message is required" })}
